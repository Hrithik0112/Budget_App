  ...
  return (
    <div>
      ...
      <div className=" w-max flex mt-10 p-10 ">
        ...
        <h3 className="text-2xl border border-black p-1">
          0 /<input placeholder="total amount " className="w-max"></input> Rs.
        </h3>
      </div>
      <div className="p-10 border-2 border-black w-max rounded-lg ml-10">
        ...
        <div>
          ...
          <h3 className="text-2xl p-2">
            Budget : <input placeholder="0 Rs." className="border border-black ml-1"></input>
          </h3>
